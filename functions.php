...
function calendars() {  
    wp_register_script( 'calendar1', get_template_directory_uri() . '/script.js',  array(), '1' );
    wp_register_script( 'calendar2', get_template_directory_uri() . '/index.global.js',  array(), '1' );  

    wp_enqueue_script( 'calendar1' );
    wp_enqueue_script( 'calendar2' );
}  
add_action( 'wp_enqueue_scripts', 'calendars' ); 
